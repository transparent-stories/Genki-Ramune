...
const page = async () => {
    ...
    return (
        <div>
            <Banner {...bannerProps} />
            <div className='my-20 mt-20 mx-4 text-center flex flex-col items-center'>
                <h1 className="text-4xl sm:text-6xl font-extrabold mb-20 text-green" data-aos="zoom-in-up">{section_1_title}</h1>
